    ...
    <div>
      {loading ? (
        ...
        <div className="flex justify-center items-center h-screen bg-white px-4">
          <div
            className={`max-w-3xl w-full bg-white grid grid-cols-1 md:grid-cols-2 shadow-lg rounded-lg overflow-hidden transition-transform duration-500 ${
          ...
          >
            ...
            <div className="p-8 flex flex-col justify-center">
              ...
              {generalError && <p className="error-message text-[#FF0000]">{generalError}</p>}
            </div>
