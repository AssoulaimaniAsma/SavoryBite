        ...
        <div className="DashBoardContainer">
            ...
            <div className="stats-button">
                <button className="stat-button">
                    <span className="TitleButton">Total Users:</span>
                    <span className="RsultButton">{userStatistics.totalUserCount}</span>
                </button>
                <button className="stat-button">
                    <span className="TitleButton">Total Restaurants:</span>
                    <span className="RsultButton">{restaurantStatistics.totalRestaurantCount}</span>
                </button>
                <button className="stat-button">
                    <span className="TitleButton">Total Food Items:</span>
                    <span className="RsultButton">{foodStatistics.totalFoodCount}</span>
                </button>
                <button className="stat-button">
                    <span className="TitleButton">Total Orders:</span>
                    <span className="RsultButton">{orderStatistics.totalOrderCount}</span>
                </button>
                <button className="stat-button">
                    <span className="TitleButton">Total Revenue:</span>
                    <span className="RsultButton">{revenueStatistics.totalRevenue} DH</span>
                </button>
            </div>

            <div className="PieChartsContainer">
                <div className="PieChartContainer">
                    <h3 className="ChartTitle">User Status</h3>
                ...
                <div className="PieChartContainer">
                    <h3 className="ChartTitle">Restaurant Status</h3>
                    <ResponsiveContainer width="100%" height={300}>
                        <PieChart>
                            <Pie 
                                data={PieData2} 
                ...
                <div className="PieChartContainer">
                    <h3 className="ChartTitle">Food Status</h3>
                    <ResponsiveContainer width="100%" height={300}>
                        <PieChart>
                            <Pie 
                                data={PieData3} 
            ...
            <div className="LineChart-BarChart">
                <div className="ChartContainer">
                    <h3 className="ChartTitle">Weekly Order Statistics</h3>
                    <ResponsiveContainer width="100%" height={300}>
